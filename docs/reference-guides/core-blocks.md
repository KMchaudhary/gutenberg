...
-	**Name:** core/group
-	**Category:** design
-	**Supports:** align (full, wide), anchor, ariaLabel, color (background, gradients, heading, link, text), dimensions (minHeight), layout (allowSizingOnChildren), media (backgroundImage), position (sticky), spacing (blockGap, margin, padding), typography (fontSize, lineHeight), ~~html~~
